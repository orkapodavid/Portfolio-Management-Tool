import reflex as rx
from starter_app.states.ui.performance_header_state import PerformanceHeaderState
        ...
        rx.el.div(
            ...
            rx.el.div(
                ...
                rx.cond(
                    ...
                    rx.el.div(
                        rx.el.div(
                            mini_grid("Gainers", PerformanceHeaderState.top_movers_a),
                            mini_grid("Losers", PerformanceHeaderState.top_movers_b),
