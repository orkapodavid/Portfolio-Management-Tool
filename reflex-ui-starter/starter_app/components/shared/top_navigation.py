...
from starter_app.states.notifications import NotificationSidebarState
from starter_app.constants import NAV_HEIGHT, NAV_BG, ICON_NAV_SIZE


def nav_button(module_name: str, icon_name: str) -> rx.Component:
    is_active = UIState.active_module == module_name

    url = "/" + module_name.lower().replace(" ", "-")
...
def top_navigation() -> rx.Component:
    ...
    return rx.el.nav(
        rx.el.div(
            ...
            rx.el.div(
                *[nav_button(name, icon) for name, icon in module_entries],
            ...
            rx.el.div(
                ...
                rx.el.div(
                    rx.el.div(
                        ...
                        rx.el.div(
                            *[
                                mobile_menu_item(name, icon)
                                for name, icon in module_entries
                            ],
