"""
Performance Header Service for Portfolio Management Tool.

Provides data for the performance header component:
...
class PerformanceHeaderService:
    """
    Service for performance header data.

    Aggregates data from MarketDataService and provides
    properly formatted data for the performance header component.
    """

    def __init__(self):
        """Initialize performance header service."""
        self.market_data_service = MarketDataService()

    async def get_kpi_metrics(self) -> List[KPIMetric]:
        """
        ...
        """
        logger.info("Fetching KPI metrics for performance header")
    ...
    async def get_top_movers(self, category: str = "ops") -> List[TopMover]:
        """
        Get top movers data for a specific category.
        ...
        """
        return await self.market_data_service.get_top_movers(category)

    async def get_portfolio_holdings(self) -> List[Holding]:
        """
        ...
        """
        logger.info("Fetching portfolio holdings for performance header")
