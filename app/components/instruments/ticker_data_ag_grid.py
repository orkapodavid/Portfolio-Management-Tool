...
def ticker_data_ag_grid() -> rx.Component:
    ...
    return rx.vstack(
        ...
        grid_toolbar(
            ...
            last_updated=InstrumentState.ticker_data_last_updated,
            show_refresh=True,
            on_refresh=InstrumentState.force_refresh_ticker_data,
            is_loading=InstrumentState.is_loading_ticker_data,
        ),
        create_standard_grid(
            grid_id=_GRID_ID,
            row_data=InstrumentState.ticker_data,
            column_defs=_get_column_defs(),
            row_id_key="ticker",
            loading=InstrumentState.is_loading_ticker_data,
