...
class EMSAOrderGridState(rx.State):
    """State for EMSA Order grid quick filter."""
...
_STORAGE_KEY = "emsa_order_grid_state"
_GRID_ID = "emsa_order_grid"
...
def emsa_order_ag_grid() -> rx.Component:
    ...
    return rx.vstack(
        ...
        grid_toolbar(
            ...
            page_name="emsa_order",
            search_value=EMSAOrderGridState.search_text,
            on_search_change=EMSAOrderGridState.set_search,
            on_search_clear=EMSAOrderGridState.clear_search,
            grid_id=_GRID_ID,
            show_compact_toggle=True,
            # Ticking pattern props
            last_updated=EMSXState.emsa_order_last_updated,
            show_refresh=True,
            on_refresh=EMSXState.force_refresh_emsa_orders,
            is_loading=EMSXState.is_loading_emsa_orders,
            auto_refresh=EMSXState.emsa_order_auto_refresh,
            on_auto_refresh_toggle=EMSXState.toggle_emsa_order_auto_refresh,
        ),
        ...
        create_standard_grid(
            ...
            default_excel_export_params=get_default_export_params("emsa_order"),
            default_csv_export_params=get_default_csv_export_params("emsa_order"),
            quick_filter_text=EMSAOrderGridState.search_text,
        ),
        width="100%",
        height="100%",
        spacing="0",
