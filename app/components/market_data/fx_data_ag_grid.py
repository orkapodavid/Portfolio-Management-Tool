...
def fx_data_ag_grid() -> rx.Component:
    """FX Data AG-Grid component with cell flash and full toolbar support."""
    ...
    return rx.vstack(
        ...
        grid_toolbar(
            ...
            page_name="fx_data",
            search_value=FxDataGridState.search_text,
            on_search_change=FxDataGridState.set_search,
        ...
        create_standard_grid(
            ...
            default_excel_export_params=get_default_export_params("fx_data"),
            default_csv_export_params=get_default_csv_export_params("fx_data"),
            quick_filter_text=FxDataGridState.search_text,
        ),
        width="100%",
        height="100%",
        spacing="0",
