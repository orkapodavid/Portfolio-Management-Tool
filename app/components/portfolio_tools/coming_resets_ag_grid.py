...
def coming_resets_ag_grid() -> rx.Component:
    ...
    return rx.vstack(
        ...
        grid_toolbar(
            ...
            last_updated=PortfolioToolsState.coming_resets_last_updated,
            show_refresh=True,
            on_refresh=PortfolioToolsState.force_refresh_coming_resets,
            is_loading=PortfolioToolsState.is_loading_coming_resets,
        ),
        create_standard_grid(
            grid_id=_GRID_ID,
            row_data=PortfolioToolsState.coming_resets,
            column_defs=_get_column_defs(),
            row_id_key="id",
            loading=PortfolioToolsState.is_loading_coming_resets,
