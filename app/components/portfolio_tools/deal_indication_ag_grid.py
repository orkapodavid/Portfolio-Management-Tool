...
def deal_indication_ag_grid() -> rx.Component:
    ...
    return rx.vstack(
        ...
        grid_toolbar(
            ...
            last_updated=PortfolioToolsState.deal_indication_last_updated,
            show_refresh=True,
            on_refresh=PortfolioToolsState.force_refresh_deal_indication,
            is_loading=PortfolioToolsState.is_loading_deal_indication,
        ),
        create_standard_grid(
            grid_id=_GRID_ID,
            row_data=PortfolioToolsState.deal_indication,
            column_defs=_get_column_defs(),
            row_id_key="id",
            loading=PortfolioToolsState.is_loading_deal_indication,
