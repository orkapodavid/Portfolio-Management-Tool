    ...
    return rx.el.div(
        rx.el.div(
            rx.el.div(
                ...
                rx.el.input(
                    type="date",
                    value=PortfolioToolsState.po_settlement_position_date,
                    on_change=PortfolioToolsState.set_po_settlement_position_date,
...
def po_settlement_ag_grid() -> rx.Component:
    ...
    return rx.vstack(
        ...
        grid_toolbar(
            ...
            last_updated=PortfolioToolsState.po_settlement_last_updated,
            show_refresh=True,
            on_refresh=PortfolioToolsState.force_refresh_po_settlement,
            is_loading=PortfolioToolsState.is_loading_po_settlement,
        ),
        # Position date selector bar
        _position_date_bar(),
        create_standard_grid(
            grid_id=_GRID_ID,
            row_data=PortfolioToolsState.po_settlement,
            column_defs=_get_column_defs(),
            row_id_key="id",
            loading=PortfolioToolsState.is_loading_po_settlement,
