    ...
    return rx.el.div(
        rx.el.div(
            rx.el.div(
                ...
                rx.el.input(
                    type="date",
                    value=PortfolioToolsState.excess_amount_position_date,
                    on_change=PortfolioToolsState.set_excess_amount_position_date,
...
def excess_amount_ag_grid() -> rx.Component:
    ...
    return rx.vstack(
        ...
        grid_toolbar(
            ...
            last_updated=PortfolioToolsState.excess_amount_last_updated,
            show_refresh=True,
            on_refresh=PortfolioToolsState.force_refresh_excess_amount,
            is_loading=PortfolioToolsState.is_loading_excess_amount,
        ),
        # Position date selector bar
        _position_date_bar(),
        create_standard_grid(
            grid_id=_GRID_ID,
            row_data=PortfolioToolsState.excess_amount,
            column_defs=_get_column_defs(),
            row_id_key="id",
            loading=PortfolioToolsState.is_loading_excess_amount,
