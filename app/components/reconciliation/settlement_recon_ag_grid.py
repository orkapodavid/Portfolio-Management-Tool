...
class SettlementReconGridState(rx.State):
    """State for Settlement Recon grid quick filter."""
    ...
    return rx.el.div(
        rx.el.div(
            rx.el.div(
                ...
                rx.el.input(
                    type="date",
                    value=ReconciliationState.settlement_recon_position_date,
                    on_change=ReconciliationState.set_settlement_recon_position_date,
...
_STORAGE_KEY = "settlement_recon_grid_state"
_GRID_ID = "settlement_recon_grid"


def settlement_recon_ag_grid() -> rx.Component:
    """Settlement Recon AG-Grid component with full toolbar support."""
    from app.components.shared.ag_grid_config import (
        grid_state_script,
        grid_toolbar,
    ...
    return rx.vstack(
        ...
        grid_toolbar(
            ...
            page_name="settlement_recon",
            search_value=SettlementReconGridState.search_text,
            on_search_change=SettlementReconGridState.set_search,
