"""
Warrant Position AG-Grid Component.
...
class WarrantPositionGridState(rx.State):
    """State for Warrant Position grid quick filter."""
...
def _get_column_defs() -> list:
    """Return column definitions for the warrant position grid."""
    return [
        ag_grid.column_def(
            field="ticker",
            header_name="Ticker",
...
_STORAGE_KEY = "warrant_position_grid_state"
_GRID_ID = "warrant_position_grid"


def warrant_position_ag_grid() -> rx.Component:
    """Warrant Position AG-Grid component with full toolbar support."""
    ...
    return rx.vstack(
        ...
        grid_toolbar(
            ...
            page_name="warrant_position",
            search_value=WarrantPositionGridState.search_text,
            on_search_change=WarrantPositionGridState.set_search,
        ...
        create_standard_grid(
            grid_id=_GRID_ID,
            row_data=PositionsState.filtered_warrant_positions,
