...
from app.components.pnl import (
    ...
    pnl_full_ag_grid,
    pnl_summary_ag_grid,
    pnl_currency_ag_grid,
)
from app.components.positions import (
    positions_ag_grid,
    stock_position_ag_grid,
    warrant_position_ag_grid,
    bond_position_ag_grid,
    trade_summary_ag_grid,
)
    ...
    workspace_content = rx.match(
        ...
        (
            ...
            rx.match(
                ...
                ("PnL Change", pnl_change_ag_grid()),
                ("PnL Full", pnl_full_ag_grid()),
                ("PnL Summary", pnl_summary_ag_grid()),
                ("PnL Currency", pnl_currency_ag_grid()),
                mock_data_table(),
            ),
        ),
        (
            ...
            rx.match(
                UIState.active_subtab,
                ("Positions", positions_ag_grid()),
                ("Stock Position", stock_position_ag_grid()),
                ("Warrant Position", warrant_position_ag_grid()),
                ("Bond Positions", bond_position_ag_grid()),
                ("Trade Summary (War/Bond)", trade_summary_ag_grid()),
                mock_data_table(),
            ),
        ),
        (
            ...
            rx.match(
                UIState.active_subtab,
                ("Restricted List", restricted_list_ag_grid()),
                ("Undertakings", undertakings_ag_grid()),
                ("Beneficial Ownership", beneficial_ownership_ag_grid()),
                ("Monthly Exercise Limit", monthly_exercise_limit_ag_grid()),
                mock_data_table(),
            ),
        ),
        (
            ...
            rx.match(
                UIState.active_subtab,
                ("Pay-To-Hold", pay_to_hold_ag_grid()),
                ("Short ECL", short_ecl_ag_grid()),
                ("Stock Borrow", stock_borrow_ag_grid()),
                ("PO Settlement", po_settlement_ag_grid()),
                ("Deal Indication", deal_indication_ag_grid()),
                ("Reset Dates", reset_dates_ag_grid()),
                ("Coming Resets", coming_resets_ag_grid()),
                ("CB Installments", cb_installments_ag_grid()),
                ("Excess Amount", excess_amount_ag_grid()),
                mock_data_table(),
            ),
        ),
        (
            ...
            rx.match(
                UIState.active_subtab,
                ("PPS Recon", pps_recon_ag_grid()),
                ("Settlement Recon", settlement_recon_ag_grid()),
                ("Failed Trades", failed_trades_ag_grid()),
                ("PnL Recon", pnl_recon_ag_grid()),
                ("Risk Input Recon", risk_input_recon_ag_grid()),
                mock_data_table(),
            ),
        ),
        (
            ...
            rx.match(
                UIState.active_subtab,
                ("Daily Procedure Check", daily_procedure_check_ag_grid()),
                ("Operation Process", operation_process_ag_grid()),
                mock_data_table(),
            ),
        ),
        (
        ...
        (
            ...
            rx.match(
                UIState.active_subtab,
                ("Event Calendar", event_calendar_ag_grid()),
                ("Event Stream", event_stream_ag_grid()),
                ("Reverse Inquiry", reverse_inquiry_ag_grid()),
                mock_data_table(),
            ),
        ),
        (
            ...
            rx.match(
                UIState.active_subtab,
                ("Ticker Data", ticker_data_ag_grid()),
                ("Stock Screener", stock_screener_ag_grid()),
                ("Special Term", special_term_ag_grid()),
                ("Instrument Data", instrument_data_ag_grid()),
                ("Instrument Term", instrument_term_ag_grid()),
                mock_data_table(),
            ),
        ),
        (
            ...
            rx.match(
                UIState.active_subtab,
                ("Delta Change", delta_change_ag_grid()),
                ("Risk Measures", risk_measures_ag_grid()),
                ("Risk Inputs", risk_inputs_ag_grid()),
