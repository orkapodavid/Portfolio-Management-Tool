                            ...
                            rx.el.div(
                                rx.el.div(
                                    ...
                                    rx.el.select(
                                        ...
                                        class_name="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 outline-none text-sm font-medium bg-white",
                                    ),
                                    class_name="mb-6",
                                ),
                                rx.el.div(
